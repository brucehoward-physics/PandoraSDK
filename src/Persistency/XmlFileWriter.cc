...
StatusCode XmlFileWriter::WriteCaloHit(const CaloHit *const pCaloHit)
{
    ...
    PANDORA_RETURN_RESULT_IF(STATUS_CODE_SUCCESS, !=, this->WriteVariable("mcMatchWeight", pCaloHit->GetMCMatchWeight()));
    PANDORA_RETURN_RESULT_IF(STATUS_CODE_SUCCESS, !=, this->WriteVariable("mcMatchPDG", pCaloHit->GetMCMatchPDG()));
